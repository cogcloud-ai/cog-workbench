...
def main():
    ...
    e=sub.add_parser('evaluate');e.add_argument('--cog',required=True);e.add_argument('--author-request',required=True);e.add_argument('--author-envelope',required=True);e.add_argument('--plan-envelope',required=True);e.add_argument('--binding-id',required=True);e.add_argument('--revision',type=int,required=True)
    ...
    try:
        ...
        elif args.op=='evaluate':result=suite.evaluate(args.cog,read(args.author_request),read(args.author_envelope),read(args.plan_envelope),{'binding_id':args.binding_id,'revision':args.revision})
